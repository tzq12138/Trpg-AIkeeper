...
- **裁决与规则 PRD（29-30）**：定义 Engine 四阶段裁决、后验物品主张、双层规则引擎。
...
20. [PRD-29 - Engine 四阶段意图裁决管线与后验物品主张](./PRD-29-Engine四阶段意图裁决管线与后验物品主张.md)
21. [PRD-30 - 双层规则引擎架构](./PRD-30-双层规则引擎架构.md)

### 2.6 Host/Player 运行时模块

22. [PRD-02 - Host 通信总线与路由分发](./PRD-02-Host通信总线与路由分发.md)
23. [PRD-03 - Host 全局 HUD 与状态聚合](./PRD-03-Host全局HUD与状态聚合.md)
24. [PRD-04 - Host 事务播放器与多级队列](./PRD-04-Host事务播放器与多级队列.md)
25. [PRD-05 - Host 氛围引擎](./PRD-05-Host氛围引擎.md)
26. [PRD-06 - Host 舞台演出与剧情渲染](./PRD-06-Host舞台演出与剧情渲染.md)
27. [PRD-07 - Player 通信网关与单播路由](./PRD-07-Player通信网关与单播路由.md)
28. [PRD-08 - Player 对讲机与语音意图](./PRD-08-Player对讲机与语音意图.md)
29. [PRD-09 - Player 活体角色卡与触控检定](./PRD-09-Player活体角色卡与触控检定.md)
30. [PRD-10 - Player 背包与线索软木板](./PRD-10-Player背包与线索软木板.md)
31. [PRD-11 - Player 战术聊天与结构化行动按钮](./PRD-11-Player战术聊天与结构化行动按钮.md)
...
| 四阶段裁决 | PRD-29、30 | 玩家意图可自动结算、触发规则、投影到 Host/Player |
...
- 第三批：PRD-24、26、29、30、02、03、04、06、07、09，跑通 AI KP 到 Engine 裁决再到 Host/Player 投影。
- 第四批：PRD-16、17、18、19、20、27、28，补齐私密协作、纠错、重连、回放和复盘。
- 第五批：PRD-05、10、11，完善氛围、背包线索和战术按钮体验。
- 后续批：PRD-08 语音/STT，待浏览器录音与 STT 接入方案稳定后实施。
